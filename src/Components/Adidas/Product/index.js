...
import AdidasGrid from "./AdidasGrid";
import AdidasList from "./AdidasList";
...
function Product() {
  ...
  return (
    <Box>
        ...
        <Grid item>
          <Box display="flex" alignItems="center">
            <Typography style={{ fontSize: 18, paddingRight: 2 }}>
              <b>All Product Adidas</b>
            </Typography>
            <ChildFriendlyIcon color="error" />
          </Box>
        </Grid>
        <Grid item>
      ...
      {viewType === "grid" ? <AdidasGrid /> : <AdidasList />}
    </Box>
  );
}
